  ...
  return (
    <footer className="max-w-[1140px]">
      <div className="flex flex-col items-center pt-[160px] footer-border mb-[80px] relative px-10">
        <img src="/text.svg" alt="" className="relative z-10 object-cover" />
      ...
      <div className="grid gap-10 px-4 lg:grid-cols-2 sm:px-10">
        <div className="flex flex-col gap-7 pr-[98px] items-start text-left text-textHeader text-base ">
          ...
          <div className="flex items-center gap-4 font-bold text-textFooterTitle">
            <span>Follow Us:</span>
        ...
        <div className="grid grid-cols-3">
          <div className="space-y-5 text-base text-left text-textHeader">
            <p className="font-bold text-textFooterTitle">Products</p>
            <p>Terminal</p>
            <p>Perpetual DEX</p>
            <p>Bridge</p>
            <p>Launchpad</p>
          ...
          <div className="space-y-5 text-base text-left text-textHeader">
            <p className="font-bold text-textFooterTitle">Resource</p>
            <p>Documentation</p>
            <p>Blogs</p>
            <p>Bridge</p>
            <p>Launchpad</p>
          ...
          <div className="space-y-5 text-base text-left text-textHeader">
            <p className="font-bold text-textFooterTitle">Regal</p>
            <p>Privacy & Policy</p>
            <p>Terms & Conditios</p>
            <p>Cookie Policy</p>
          </div>
      ...
      <div className="flex flex-col gap-6 px-4 text-base text-justify text-textHeader">
