...
const Hero = () => {
  ...
  return (
    <div className="hero-bg max-w-[1154px] w-full mt-[120px] mb-[74px] flex flex-col items-center relative px-6 text-center">
      <div className="flex flex-col gap-9 items-center max-w-[740px] mt-[40px]">
        <h1 className="text-textButton font-bold sm:!text-[64px] !text-[40px]">Stake to Earn Up To 30% APY</h1>
        <p className="text-xl text-center text-textFooterTitle">To develop an advanced AI-powered crypto trading platform where the platform conducts trading on behalf of users, leveraging Bitcoin dominance trends and advanced AI algorithms to maxmize profits.</p>
        <button
    ...
    border rounded-lg cursor-pointer transition-all duration-200 ease-in-out h-[46px] w-[170px] flex justify-center items-center  text-base  tracking-[0.32px] group relative`}
        >
          {publicKey ? (
            <Link href="/dashboard">Connecting...</Link>
          ) : (
